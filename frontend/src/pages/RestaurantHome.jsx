...
const RestaurantHome = () => {
  ...
  const { restaurant, restaurantLoading } = useContext(AppContext);
          ...
          >
            ...
            <div className="w-full h-16 md:h-24 bg-[#f5f5f5] border-b border-b-[#a19595b6] flex items-center px-4 md:px-20 justify-between">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="size-12 border-2  border-green-500 rounded-full flex items-center justify-center"
                  onClick={() => navigate('/restaurant-dashboard/profile')}>
                  <img src={restaurant?.logo || DefaultImage} className="bg-zinc-400 rounded-full"></img>
                </div>
              </div>
